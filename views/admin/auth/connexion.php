...
<body class="d-flex justify-content-center">
    <div class="container d-flex flex-column justify-content-center align-items-center">
        <div class="col-12 col-sm-10 col-lg-6">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="../../../controllers/admin/connexion.php" class="bg-white p-3 shadow rounded mt-3" method="post">
                        <div class="row">
                            <div class="col-12">
                                <input type="email" name="email" class="form-control p-3" placeholder="Email admin" />
