                    ...
                    <div class="col-12">
                        <nav>
                            <ul class="d-flex flex-column list-unstyled">
                                ...
                                <li class="">
                                    <a href="./emprunt.php" class="sidebar-link text-decoration-none active text-black d-none d-lg-flex">
                                            ...
                                            <tbody>
                                                <?php foreach ($emprunts as $emprunt) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlspecialchars($emprunt['date_debut']); ?></td>
                                                        <td><?php echo htmlspecialchars($emprunt['date_fin']); ?></td>
                                                        <td><?php echo htmlspecialchars($emprunt['status']); ?></td>
                                                        <td>
                                                            <?php if ($emprunt['status'] == 'en cours') : ?>
                                                                <form method="POST" action="../../../controllers/admin/annulerEmprunt.php">
                                                                    <input type="hidden" name="id_emprunt" value="<?php echo $emprunt['id_emprunt']; ?>">
                                                                    <button type="submit" class="btn btn-danger">Annuler</button>
                                                                </form>
                                                            <?php endif; ?>
                                                            <form method="POST" action="../../../controllers/admin/terminerEmprunt.php" style="display: inline;">
                                                                <input type="hidden" name="id_emprunt" value="<?php echo $emprunt['id_emprunt']; ?>">
