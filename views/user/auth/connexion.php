...
<body class="d-flex justify-content-center" style="background-image: linear-gradient(
    to left bottom,
    #ffffff,
    #e3e4fe,
    #bfcbfe,
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center">
        <div class="col-12 col-sm-10 col-lg-6">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="../../../controllers/user/connexion.php" class="bg-white p-3 shadow rounded mt-3" method="post">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="mt-3">
                            <p class="m-0 text-center">Vous n'avez pas de compte ? <a href="./inscription.php" class="text-decoration-none connecte">S'inscrire</a></p>
                        </div>
                    </form>
                </div>
            </div>
